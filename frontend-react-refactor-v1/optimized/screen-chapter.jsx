...
const ScreenChapter = ({ params, onNavigate }) => {
  const chapter = SAMPLE_CHAPTER;
      ...
      <div style={{
        ...
        <div className="container hstack" style={{ height: 48, gap: 14 }}>
          ...
          <nav className="crumb" style={{ flex: 1, minWidth: 0 }}>
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate("course", { id: course.id }); }} style={{
          ...
          <div className="hstack" style={{ gap: 2 }}>
            <button
              ...
              aria-disabled={!prev}
              disabled={!prev}
              onClick={() => prev && onNavigate("chapter", { id: prev.id })}
            ...
            <button
              ...
              aria-disabled={!next}
              disabled={!next}
              onClick={() => next && onNavigate("chapter", { id: next.id })}
      ...
      <div className="container layout-2col-left">
        ...
        <main style={{ paddingTop: 8 }}>
          ...
          <div className="card" style={{
            ...
            <button className="btn btn-primary" onClick={() => onNavigate("lab", { id: 35 })}>
          ...
          <div style={{ marginTop: 32, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <NavCard chapter={prev} dir="prev" onClick={() => prev && onNavigate("chapter", { id: prev.id })} />
            <NavCard chapter={next} dir="next" onClick={() => next && onNavigate("chapter", { id: next.id })} />
          </div>
      ...
      {drawerOpen && (
        <MobileDrawer onClose={() => setDrawerOpen(false)}>
          <ChapterSidebar
            ...
            onNavigate={(...args) => { setDrawerOpen(false); onNavigate(...args); }}
          />
        </MobileDrawer>
      )}
...
Object.assign(window, { ScreenChapter });
