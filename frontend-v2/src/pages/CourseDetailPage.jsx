    ...
    <div className="screen container" style={{ paddingTop: 20 }}>
      ...
      <div className="layout-2col">
        <main>
          <ChapterListPanel
            course={course}
            onOpenChapter={(ch) => navigate('/' + (ch.type === "lab" ? "lab" : "chapter") + '/' + ch.id)}
          />
        </main>

        <aside className="sidebar">
          <div className="sidebar-sticky vstack" style={{ gap: 16 }}>
            <CourseProgressCard course={course} pct={pct} nextChapter={nextChapter} onContinue={() => nextChapter && navigate('/' + (nextChapter.type === "lab" ? "lab" : "chapter") + '/' + nextChapter.id)} />
...
export default ScreenCourseDetail;
