...
const PathOverview = ({ navigate, courses }) => {
  ...
  return (
    <div className="card" style={{ padding: 20, display: "flex", flexDirection: "column" }}>
      ...
      <button className="btn btn-secondary btn-sm" style={{ width: "100%" }} onClick={() => navigate('/courses')}>
...
const CourseProgressList = ({ navigate, courses }) => (
  <div className="card" style={{ padding: 20 }}>
