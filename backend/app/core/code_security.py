...
FORBIDDEN_MODULES: Set[str] = {
    ...
    'urllib.parse', 'urllib.error', 'urllib.robotparser', 'urllib2',
    'httplib', 'http.client', 'http.server', 'ftplib', 'poplib', 
    'imaplib', 'smtplib', 'smtpd', 'nntplib', 'telnetlib', 'xmlrpc',
    'requests', 'urllib3', 'aiohttp', 'httpx', 'pycurl', 'wget',
    'tornado', 'twisted', 'gevent', 'eventlet',
    'pty', 'tty', 'termios', 'fcntl', 'select', 'selectors',
    'signal', 'multiprocessing', 'concurrent.futures', 'asyncio',
    'threading', '_thread', 'dummy_threading', 'queue', 'pipes',
    'platform', 'site', 'importlib', 'imp', 'runpy', 'pkgutil',
    'modulefinder', 'zipimport', 'zipfile', 'tarfile', 'shutil',
    'pathlib', 'path', 'glob', 'fnmatch', 'linecache', 'traceback',
    'gc', 'weakref', 'types', 'inspect', 'code', 'codeop', 'bdb',
    'pdb', 'trace', 'cProfile', 'profile', 'pstats', 'timeit',
    'compileall', 'py_compile', 'symtable', 'parser', 'ast', 'tokenize',
    'token', 'keyword', 'dis', 'pickle', 'pickletools', 'copyreg',
    'shelve', 'dbm', 'dbm.gnu', 'dbm.ndbm', 'dbm.dumb', 'sqlite3',
    'sqlite', 'mimetypes', 'base64', 'binascii', 'quopri', 'uu',
    'encodings', 'codecs', 'unicodedata', 'stringprep', 'readline',
    'rlcompleter', 'crypt', 'spwd', 'grp', 'pwd', 'termios', 'tty',
    'pty', 'fcntl', 'resource', 'nis', 'syslog', 'getpass', 'curses',
    'ssl', 'hashlib', 'hmac', 'secrets', 'uuid', 'ipaddress',
    'macpath', 'posixpath', 'ntpath', 'genericpath', 'cmd', 'shlex',
    'pipes', 'socketserver', 'http', 'http.cookies', 'http.cookiejar',
    'wsgiref', 'cgi', 'cgitb', 'wsgiref', 'webbrowser', 'netrc',
    'mimetools', 'rfc822', 'basehttpserver', 'simplehttpserver',
    'cghttpserver', 'cookie', 'cookielib', 'html', 'html.parser',
    'html.entities', 'xml', 'xml.etree', 'xml.dom', 'xml.sax',
    'xml.parsers', 'pyexpat', 'plistlib', 'xdrlib', 'msilib',
    'msvcrt', 'winreg', 'winsound', 'win32api', 'win32con', 'ctypes',
    'ctypes.wintypes', 'ctypes.util', '_ctypes', 'mmap', 'msvcrt',
    'winreg', 'winsound', 'spwd', 'nis', 'syslog', 'optparse',
    'getopt', 'fileinput', 'calendar', 'collections.abc',
    'contextlib', 'abc', 'atexit', 'tracemalloc', 'faulthandler',
    'warnings', 'linecache', 'tracemalloc', 'reprlib', 'enum',
    'graphlib', 'typing', 'dataclasses', 'contextvars', 'zoneinfo',
    '_threading_local', 'sched', 'mailcap', 'mailbox', 'mhlib',
    'mimetools', 'rfc822', 'basehttpserver', 'simplehttpserver',
    'sunau', 'wave', 'chunk', 'colorsys', 'imghdr', 'sndhdr',
    'ossaudiodev', 'sunaudiodev', 'ossaudiodev', 'audioop', 'imageop',
    'rgbimg', 'jpeg', 'cd', 'fl', 'fm', 'gl', 'imgfile', 'sv',
    'al', 'ml', 'cdrom', 'cl', 'sgi', 'al', 'sunaudiodev',
}
...
FORBIDDEN_FUNCTIONS: Set[str] = {
    ...
    'os.fork', 'os.forkpty', 'os.kill', 'os.killpg', 'os.wait',
    'os.waitpid', 'os.wait3', 'os.wait4', 'os.waitid',
    'os.remove', 'os.unlink', 'os.rmdir', 'os.removedirs',
    'os.rename', 'os.renames', 'os.replace', 'os.makedirs',
    'os.mkdir', 'os.chmod', 'os.chown', 'os.chroot', 'os.fchmod',
    'os.fchown', 'os.lchmod', 'os.lchown', 'os.chflags', 'os.lchflags',
    'os.mkfifo', 'os.mknod', 'os.link', 'os.symlink', 'os.readlink',
    'os.setuid', 'os.setgid', 'os.seteuid', 'os.setegid',
    'os.setreuid', 'os.setregid', 'os.setgroups', 'os.initgroups',
    'os.getuid', 'os.getgid', 'os.geteuid', 'os.getegid',
    'os.getgroups', 'os.getlogin', 'os.getloadavg',
    'subprocess.call', 'subprocess.check_call', 'subprocess.check_output',
    'subprocess.run', 'subprocess.Popen', 'subprocess.getoutput',
    'subprocess.getstatusoutput', 'subprocess.list2cmdline',
    'sys.exit', 'sys._exit', 'sys.modules', 'sys.path', 'sys.argv',
    '__builtins__.__import__', '__builtins__.open',
    '__builtins__.exec', '__builtins__.eval', '__builtins__.compile',
    'socket.socket', 'socket.create_connection', 'socket.getaddrinfo',
    'socket.gethostbyname', 'socket.gethostbyaddr',
    'builtins.open', 'builtins.exec', 'builtins.eval', 'builtins.compile',
    'builtins.__import__',
}
...
FORBIDDEN_ATTRIBUTES: Set[str] = {
    ...
    '__module__', '__dict__', '__class__', '__self__',
    '__weakref__', '__slots__', '__get__', '__set__', '__delete__',
    '__getattr__', '__getattribute__', '__setattr__', '__delattr__',
    '__getstate__', '__setstate__', '__reduce__', '__reduce_ex__',
    '__getinitargs__', '__getnewargs__', '__getnewargs_ex__',
    '__hash__', '__call__', '__new__', '__init__', '__del__',
    '__enter__', '__exit__', '__iter__', '__next__', '__aiter__',
    '__anext__', '__await__', '__aenter__', '__aexit__',
    'func_globals', 'gi_frame', 'gi_code', 'gi_yieldfrom',
    'cr_frame', 'cr_code', 'cr_origin', 'tb_frame', 'tb_next',
    'f_back', 'f_builtins', 'f_globals', 'f_locals', 'f_code',
    'f_trace', 'f_trace_lines', 'f_trace_opcodes', 'co_code',
...
ALLOWED_MODULES: Set[str] = {
    ...
    'collections', 'collections.abc', 'heapq', 'bisect', 'array', 'copy', 'pprint',
    'reprlib', 'enum', 'graphlib', 'dataclasses', 'contextvars',
    'itertools', 'functools', 'operator', 'pathlib', 'os.path',
    're', 'string', 'struct', 'difflib', 'textwrap', 'unicodedata',
    'stringprep', 'readline', 'rlcompleter',
    'json', 'csv', 'configparser', 'tomllib',
    'hashlib', 'hmac', 'secrets',
    'inspect', 'types', 'typing', 'abc', 'atexit', 'traceback',
    'warnings', 'contextlib', 'dataclasses', 'enum',
    'numpy', 'pandas', 'matplotlib', 'matplotlib.pyplot',
    'sklearn', 'scipy', 'scipy.stats', 'scipy.optimize',
}
...
class CodeSecurityChecker:
    ...
    def _check_call(self, node: ast.Call):
        ...
        if isinstance(node.func, ast.Name):
            ...
            if attr_name in ['system', 'popen', 'popen2', 'popen3', 'popen4',
