...
import lab02_starter as student  # noqa: E402
...
def test_gradient_descent_converges():
    ...
    ), f"Loss not decreasing: {initial_loss:.4f} → {final_loss:.4f}"
...
def test_gradient_descent_l2():
    ...
    assert (
        l2_norm_l2 < l2_norm_none
    ), f"L2 should shrink weights: {l2_norm_l2:.4f} >= {l2_norm_none:.4f}"
