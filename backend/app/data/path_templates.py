...
PATH_TEMPLATES = [
    {
        "slug": "ai-researcher",
        "name": "AI专家路径",
        "description": "深入研究AI理论与前沿技术，适合追求算法创新的学习者。涵盖深度学习、大语言模型、强化学习等高级主题。",
        "duration_weeks": 20,
        "target_role": "AI专家",
        "required_courses": [],  # 将在T3中填充
        "elective_courses": [],
        "capstone_count": 2,
    },
    {
        "slug": "ai-engineer",
        "name": "AI工程师路径",
        "description": "侧重工程实现与系统构建，培养能独立开发AI产品的工程师。包含MLOps、模型部署、性能优化等实践技能。",
        "duration_weeks": 14,
        "target_role": "AI工程师",
        "required_courses": [],
        "elective_courses": [],
    ...
    },
    {
        "slug": "ai-applier",
        "name": "AI应用者路径",
        "description": "快速掌握AI工具与API应用，适合希望将AI融入现有工作的专业人士。聚焦Prompt工程、RAG应用、AI工作流。",
        "duration_weeks": 8,
        "target_role": "AI应用者",
        "required_courses": [],
        "elective_courses": [],
    ...
    },
    {
        "slug": "ai-manager",
        "name": "AI管理者路径",
        "description": "培养AI项目管理与战略规划能力，适合技术管理者与决策者。学习AI项目管理、团队搭建、ROI评估等内容。",
        "duration_weeks": 6,
        "target_role": "AI管理者",
        "required_courses": [],
        "elective_courses": [],
...
def seed_path_templates(db):
    """Insert path template seed data if not exists."""
    from app.models.path import PathTemplate

    existing_slugs = {t.slug for t in db.query(PathTemplate).all()}

    for template_data in PATH_TEMPLATES:
        if template_data["slug"] not in existing_slugs:
...
def seed_all_path_data(db):
    """Seed all path-related data."""
    seed_path_templates(db)
